...
Private Sub Form_Load()
    ...
    vbCrLf & "Version 3.02.2006" & _
    vbCrLf & "Product ID : AS-EP-VER-3.0" & vbCrLf & vbCrLf & "Created By" & _
    vbCrLf & "MANOJBABU" & _
    vbCrLf & vbCrLf & "Editor Plus 3.0" & _
    ...
    vbCrLf & "Create RTF,TXT,DOC,etc.. Files." & _
    vbCrLf & "Insert Embeded Files Insert Current System Date & Time" & _
    vbCrLf & "Text Formating (Bold,Italic,Underline,Strike,Bullets," & _
    vbCrLf & "Alignmets,Fore Color,Back Color,Fonts and Etc..)" & _
